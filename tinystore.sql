...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Авг 30 2021 г., 18:22
...
INSERT INTO `good` (`id`, `idcategory_id`, `name`, `image`, `price`, `description`) VALUES
...
INSERT INTO `good_order` (`id`, `idgood_id`, `amount`, `idorder_id`) VALUES
(1, 1, 2, 2),
(2, 3, 2, 2),
(14, 1, 3, 4),
(15, 7, 1, 4);
...
(4, '2021-08-30 16:57:02', '2021-08-30 17:51:28', 'cart');
...
ALTER TABLE `good`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_6C844E92D487ED4D` (`idcategory_id`);
...
ALTER TABLE `good_order`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_EB8A3D4CC3FDDE1E` (`idgood_id`),
  ADD KEY `IDX_EB8A3D4C274A2535` (`idorder_id`);
...
--
ALTER TABLE `good`
  ADD CONSTRAINT `FK_6C844E92D487ED4D` FOREIGN KEY (`idcategory_id`) REFERENCES `category` (`id`);

--
-- Ограничения внешнего ключа таблицы `good_order`
--
ALTER TABLE `good_order`
  ADD CONSTRAINT `FK_EB8A3D4C274A2535` FOREIGN KEY (`idorder_id`) REFERENCES `order` (`id`),
  ADD CONSTRAINT `FK_EB8A3D4CC3FDDE1E` FOREIGN KEY (`idgood_id`) REFERENCES `good` (`id`);
COMMIT;
